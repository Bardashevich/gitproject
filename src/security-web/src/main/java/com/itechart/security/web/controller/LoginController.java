...
public class LoginController {
    ...
    public SessionInfoDto login(@RequestBody LoginDataDto data, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (authentication != null && userDetails.getUserId() == null) {
            authentication = authenticationManager.authenticate(authenticationToken);
            SecurityContextHolder.getContext().setAuthentication(authentication);
            userDetails = SecurityUtils.getUserDetails(authentication);
        }
        ...
        info.setToken(token);
        info.setCountUnreadComments(contactService.getCountUnreadComments());
    ...
    public SessionInfoDto getRoles() {
        ...
        sessionInfo.setUserId(((UserDetails)authentication.getPrincipal()).getUserId());
        sessionInfo.setCountUnreadComments(contactService.getCountUnreadComments());
        return sessionInfo;
    }

(function () {
    ...
    function TaskEditController(taskService, taskSecurityService, authService, taskCommonService, dialogService, $stateParams, $q) {
        ...
        vm.title = 'Edit Task';
        vm.submitText = 'Save';
        vm.dateErrorText = 'invalid date';
        vm.isEndDateInvalid = false;
        ...
        (function () {
            ...
            taskService.getTaskById($stateParams.id).then(function (response) {
                ...
                vm.timeless = !!(vm.task.startDate === null && vm.task.endDate === null);
                ...
                $q.all([
                    ...
                    vm.canEditDateTime = !!(vm.canEdit && !vm.timeless);
                });
            });
        })();
